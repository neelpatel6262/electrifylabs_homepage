    ...
    <section className="cta-section" aria-labelledby="cta-title">
      <div className="cta-container">
        ...
        <div className="cta-btn">
          ...
          {/* Cookie consent - made functional */}
          <div className="cookie-consent" style={{ marginTop: '10px', fontSize: '12px', opacity: 0.8 }}>
            By submitting, you agree to our <a href="#" style={{ textDecoration: 'underline' }}>Privacy Policy</a> and <a href="#" style={{ textDecoration: 'underline' }}>Terms of Service</a>.
          </div>
        </div>
